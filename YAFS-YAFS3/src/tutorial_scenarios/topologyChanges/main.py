...
def main(stop_time, it):
    ...
    """
    dataApp = json.load(open('/Users/tingxu/Desktop/Fog-computing/Fog-Computing-Dissertation-Code/YAFS-YAFS3/YAFS-YAFS3/src/tutorial_scenarios/topologyChanges/data/appDefinition.json'))
    apps = create_applications_from_json(dataApp)

    """
    SERVICE PLACEMENT 
    """
    placementJson = json.load(open('/Users/tingxu/Desktop/Fog-computing/Fog-Computing-Dissertation-Code/YAFS-YAFS3/YAFS-YAFS3/src/tutorial_scenarios/topologyChanges/data/allocDefinition.json'))
    ...
    Deploy users
    """
    userJSON = json.load(open('/Users/tingxu/Desktop/Fog-computing/Fog-Computing-Dissertation-Code/YAFS-YAFS3/YAFS-YAFS3/src/tutorial_scenarios/topologyChanges/data/usersDefinition.json'))
...
if __name__ == '__main__':
    ...
    nIterations = 4  # iteration for each experiment
