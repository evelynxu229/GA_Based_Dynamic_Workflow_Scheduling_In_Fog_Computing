...
def main(simulated_time,experimento,ilpPath):
    ...
    print(t.get_nodes()[100])
    print(t.get_nodes_att()[0]['RAM'])
    

    """
    APPLICATION
    """
    dataApp = json.load(open('/Users/tingxu/Desktop/Fog-computing/Fog-Computing-Dissertation-Code/YAFS-YAFS3/YAFS-YAFS3/src/tutorial_scenarios/serviceMovement/data/moduleExperiment/8apps_10modules_per_app/appDefinition.json'))
    ...
    PLACEMENT algorithm
    """
    placementJson = json.load(open('/Users/tingxu/Desktop/Fog-computing/Fog-Computing-Dissertation-Code/YAFS-YAFS3/YAFS-YAFS3/src/tutorial_scenarios/serviceMovement/data/moduleExperiment/8apps_10modules_per_app/allocDefinition.json'))
    ...
    dataPopulation = json.load(open('/Users/tingxu/Desktop/Fog-computing/Fog-Computing-Dissertation-Code/YAFS-YAFS3/YAFS-YAFS3/src/tutorial_scenarios/serviceMovement/data/moduleExperiment/8apps_10modules_per_app/usersDefinition.json'))
...
if __name__ == '__main__':
    ...
    import os
    pathExperimento = "/Users/tingxu/Desktop/Fog-computing/Fog-Computing-Dissertation-Code/YAFS-YAFS3/YAFS-YAFS3/src/examples/Tutorial_JSONModelling/case/"
    ...
    main(simulated_time=1000,  experimento=pathExperimento,ilpPath='')
    #print("Running: ILP ")
