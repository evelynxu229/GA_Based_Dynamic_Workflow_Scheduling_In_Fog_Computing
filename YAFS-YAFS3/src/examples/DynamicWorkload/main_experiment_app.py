...
def main_static_app(untiltime, experimentId, degree, depth):
...
def main_dynamic_app(untiltime,experimentId, degree, depth):
    ...
    print("initial plan is :", final_plan)
...
if __name__ == '__main__':
    ...
    """
    with open(current_directory+'/results/experiments/application_size/static/output.txt', 'w') as file:
        sys.stdout = file
        ...
        for appSize in app_size:
            print(' ')
            print("****************Start Static Scheduling of application size "+ str(appSize)+'****************')
            pointer=0
            static_fitness_each_experiment=0
            while pointer<10:
                print(' ')
                print("----Experiment repeat time:"+str(pointer)+'----')
                static_plan, static_measured_latency = main_static_app( 4000, appSize , 3, 4)
    ...
    for item in app_size_dynamic:
        ...
        with open(current_directory+'/results/experiments/application_size/dynamic/output_'+str(item)+'.txt', 'w') as file:
            sys.stdout = file
            while pointer<10:
                print(' ')
                print("----Experiment repeat time:"+str(pointer)+'----')
                old_plan_estimated_latency, old_plan_measured_latency, final_plan_measured_latency, final_plan_estimated_latency, old_plan, final_plan=main_dynamic_app(untiltime=4000, experimentId=item, degree=3, depth=4)
    ...
    print("GA-based static scheduling measured latency of each size of application")
    print(static_scheduling_fitness)
    print("GA-based dynamic scheduling measured latency of each size of application")
    print(dynamic_scheduling_fitness)
    print("EdgePlacement-based scheduling measured latency of each size of application")
