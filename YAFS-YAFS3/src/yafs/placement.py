...
class Placement(object):
    ...
    def __init__(self,name,activation_dist=None,logger=None):
        ...
        self.scaleServices = []
        #print("Placement init","object",object,"name",self.name,"activation",self.activation_dist)


    def scaleService(self,scale):
        self.scaleServices = scale
        print("scaling to",len(scale))
    ...
    def initial_allocation(self,sim,app_name):
        ...
        """
        print("init module allocation on topology")
    ...
    def run(self,sim):
        ...
        Args:
            sim (:mod: yafs.core.Sim)
        """
        print("runtime module allocation on topology")
...
class JSONPlacement(Placement):
    def __init__(self, json, **kwargs):
        ...
        self.data = json
        #print("JSONPlacement init function")
    ...
    def initial_allocation(self, sim, app_name):
        ...
        #print("JSONPlacement init allocation")
...
class JSONPlacementOnCloud(Placement):
    def __init__(self, json,idCloud, **kwargs):
        ...
        print("JSONPlacement on cloud init function")
    ...
    def initial_allocation(self, sim, app_name):
        ...
        print("JSONPlacement on cloud init allocation")
...
class ClusterPlacement(Placement):
    ...
    def initial_allocation(self, sim, app_name):
        ...
        print("cluster allocation of module", module)
    #end function
...
class EdgePlacement(Placement):
    ...
    def initial_allocation(self, sim, app_name):
        ...
        print("edge allocation of module", module)
